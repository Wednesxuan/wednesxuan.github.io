...
(function() {
    ...
    // ★★★ 修复：统一使用 getCodecName 映射，确保返回简称 ★★★
    ...
    function renderListForStep(container, step, panel) {
        ...
        if (step === 1) {
            ...
            // ★★★ 如果按编码过滤后为空，且 codecForList 不为空，则回退到无过滤 ★★★
    ...
    function showAboutDialog() {
        ...
        version.textContent = '当前版本 v1.0.3.103-dev';
    ...
    // ★★★ 拦截器（XHR + fetch），捕获 playurl 响应，存入缓存 ★★★
